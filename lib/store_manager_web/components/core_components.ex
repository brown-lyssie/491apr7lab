defmodule StoreManagerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StoreManagerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StoreManagerWeb.Gettext, "errors", msg, opts)
    end
  end
